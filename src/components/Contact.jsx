  ...
  return (
    <section id="contact" className="py-20 bg-primary-bg">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <SectionTitle id="contact-title">Disponível</SectionTitle>
        <motion.div 
        ...
        >
          <p className="text-lg text-text-secondary mb-8 leading-relaxed">
            Atualmente estou aberto a novas oportunidades e colaborações. Seja para compartilhar uma ideia de projeto, tirar uma dúvida ou apenas dizer um “oi”, minha caixa de entrada está sempre aberta. Farei o possível para responder!
          </p>
          <a
