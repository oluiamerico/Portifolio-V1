  ...
  return (
    <section id="about" className="py-20 bg-secondary-bg">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <SectionTitle id="about-title">Sobre Mim</SectionTitle>
        ...
        >
          <p className="text-lg text-text-secondary leading-relaxed">
            Olá! Sou o Luis, um engenheiro de software apaixonado por entender a fundo os problemas e encontrar soluções claras e eficazes. Minha mentalidade vai além do código — busco sempre criar soluções significativas que realmente gerem impacto para os usuários. O que me motiva é a vontade constante de aprender, inovar e contribuir para projetos que fazem a diferença. Gosto de colaborar em equipe e encaro cada desafio como uma oportunidade de crescer e entregar valor.
          </p>
        ...
        <h3 className="text-2xl font-semibold text-center text-accent-1 mb-8 font-mono">Educação</h3>
